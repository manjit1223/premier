...
const FAQs = () => {
  ...
  return (
    <div className="p-5 md:px-10 text-white">
      <p className="text-4xl md:text-6xl font-bold abril-fatface mb-6">
      ...
      <p>
        *As Premier Art Holdings Ltd. evolves and regulations change FAQs will
        be updated. Answers in FAQs are based on current operations and
        understandings of regulations. Nothing on this website is intended as an
        offering of a security Premier does not solicit investors, and the
