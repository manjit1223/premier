...
function ContactUsForm() {
  ...
  const onSubmit = async (formValue) => {
    ...
    try {
      ...
      const data = { ...formValue, date: currentDateTime, requireInvitation: flag };
      if (!isPhoneEnabled) {
  ...
  return (
    <div className="flex items-center justify-center px-4 py-20 overflow-hidden w-full h-screen">
      <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-[1078px] p-6 sm:p-8 bg-[#FFFFFF]/25 rounded-lg shadow-lg">
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 w-full">
            <div className="w-full">
              <input
                ...
                className={clsx([
                  styles.inputbox,
                  "p-2 text-white bg-transparent border border-white rounded-xl w-full",
                ])}
                {...register("firstName", {
          ...
          <div className="w-full">
            <label className="text-white">Preferred Method of Contact *</label>
            <div className="mt-2 flex flex-col gap-2">
              {checkboxValue.map((method) => (
                <div key={method.value} className="flex items-center gap-2">
                  ...
                  />
                  <label className="text-white">{method.label}</label>
                </div>
              ))}
            </div>
            ...
            <div className="w-full">
              <div className="flex gap-4">
                <select
                  ...
                  className={clsx([
                    styles.inputbox,
                    "text-white bg-[#3E3C3C] rounded-xl border border-white w-1/3",
                  ])}
                >
          ...
          <div className="w-full">
            <select
              ...
              className="text-white bg-[#3E3C3C] rounded-xl border border-white w-full h-11"
            >
          ...
          <textarea
            placeholder="Comment"
            className="p-2 text-white bg-transparent border border-white rounded-xl w-full"
            {...register("comment")}
          />
